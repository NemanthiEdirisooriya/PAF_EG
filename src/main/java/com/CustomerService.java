...
public class CustomerService {
	...
	public String insertCustomer(@FormParam("CustomerName") String CustomerName,
			@FormParam("CustomerEmail") String CustomerEmail, @FormParam("CustomerAddress") String CustomerAddress,
	...
	public String updateCustomer(String customerData) {
		...
		String output = customerObj.updateCustomer(CustomerID, CustomerName, CustomerEmail, CustomerAddress,
				CustomerContact);
		return output;
	}
